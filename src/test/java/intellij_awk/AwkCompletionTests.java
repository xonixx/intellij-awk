...
public class AwkCompletionTests extends BasePlatformTestCase {
  ...
  public void testInsideString_6_1() {
    checkCompletionAuto(
        "BEGIN { A[\"aaa123\"]; B = \"aaa1<caret>\" }",
        "BEGIN { A[\"aaa123\"]; B = \"aaa123<caret>\" }");
  }

  public void testInsideString_6_2() {
    checkCompletionAuto(
        "BEGIN { A = \"xxx aaa123\"; f(\"yyy aaa1<caret>\") }",
  ...
  public void testInsideERE_4() {
    checkCompletionEmpty("BEGIN { A=@/<caret>/ }");
  }
